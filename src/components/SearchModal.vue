  ...
  <div class="modal-content">
    <form class="box">
        <div class="field is-grouped">
            ...
            <div class="control">
                <button class="button" :class="(searchMode==='Name')?'is-dark':'is-light'" @click.prevent="setSearchMode('Name')">Name</button>
            </div>
            <div class="control">
                <button class="button" :class="(searchMode==='Zip')?'is-dark':'is-light'" @click.prevent="setSearchMode('Zip')">Zip code</button>
            </div>
            <div class="control">
                <button class="button" :class="(searchMode==='Coordinates')?'is-dark':'is-light'" @click.prevent="setSearchMode('Coordinates')">Coordinates</button>
            </div>
        </div>
        <div class="field is-grouped">
            <div class="control">
